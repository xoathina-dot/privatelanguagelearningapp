        ...
        lessons: [
          { id: 'u1l1', title: 'Χαιρετισμοί', sub: 'Begrüßungen', xp: 10,
            ...
            quiz: [
              ...
              { prompt: 'Καλησπέρα', answer: 'Guten Abend', options: ['Guten Abend', 'Guten Morgen', 'Gute Nacht'],
                explanation: '"Guten Abend" λέγεται από αργά το απόγευμα (περίπου 18:00) και μετά — διαφορετικό από το "Gute Nacht" που λέγεται μόνο πριν τον ύπνο.' },
              { prompt: 'Καλή μέρα (μέση της ημέρας)', answer: 'Guten Tag', options: ['Guten Tag', 'Guten Morgen', 'Gute Nacht'],
                explanation: '"Guten Tag" καλύπτει το μεγαλύτερο μέρος της ημέρας — από το πρωί (μετά το "Guten Morgen") μέχρι το απόγευμα.' },
          ...
          { id: 'u1l2', title: 'Ναι, όχι, ευχαριστώ', sub: 'Ja, nein, danke', xp: 10,
            ...
            quiz: [
              ...
              { prompt: 'Παρακαλώ (απάντηση σε ευχαριστίες)', answer: 'Bitte schön', options: ['Bitte schön', 'Danke schön', 'Kein Problem'],
                explanation: 'Το "bitte" απαντά σε ευχαριστίες, αλλά σημαίνει ΚΑΙ "παρακαλώ" όταν ζητάς κάτι — προσοχή στα συμφραζόμενα.' },
              { prompt: 'Συγγνώμη', answer: 'Entschuldigung', options: ['Entschuldigung', 'Bitte', 'Danke'],
                explanation: '"Entschuldigung" χρησιμοποιείται και για συγγνώμη και για να τραβήξεις την προσοχή κάποιου (π.χ. "συγγνώμη, πού είναι...;").' },
          ...
          { id: 'u1l3', title: 'Πώς είσαι;', sub: "Wie geht's?", xp: 10,
            ...
            quiz: [
              ...
              { prompt: 'Κι εσύ;', answer: 'Und dir?', options: ['Und dir?', 'Und du?', 'Und dich?'],
                explanation: 'Σωστή δοτική "dir" (σε εσένα), όχι ονομαστική "du". Ίδια λογική με το "Wie geht es dir".' },
              { prompt: 'Κι εγώ καλά', answer: 'Mir geht es auch gut', options: ['Mir geht es auch gut', 'Ich bin auch gut', 'Ich habe auch gut'],
                explanation: 'Ξανά δοτική: "Mir geht es..." (σε εμένα πάει...), όχι "Ich bin..." — το ρήμα είναι πάντα "gehen", ποτέ "sein" σε αυτή τη φράση.' },
              { prompt: 'Όχι και τόσο καλά', answer: 'Nicht so gut', options: ['Nicht so gut', 'Nicht gut so', 'So nicht gut'],
                explanation: 'Το "nicht" (δεν/όχι) μπαίνει πριν από το "so gut" (τόσο καλά) — σειρά που πρέπει να απομνημονευτεί.' },
            ] },
        ],
      },
      {
        ...
        lessons: [
          { id: 'u2l1', title: 'Πώς σε λένε;', sub: 'Wie heißt du?', xp: 10,
            ...
            quiz: [
              ...
              { prompt: 'Ποιο είναι το επίθετό σου;', answer: 'Wie ist dein Nachname?', options: ['Wie ist dein Nachname?', 'Wie ist dein Vorname?', 'Wie ist dein Name?'],
                explanation: '"Der Nachname" = επίθετο, "der Vorname" = μικρό όνομα. Μη μπερδεύεις τα δύο!' },
          ...
          { id: 'u2l2', title: 'Από πού είσαι;', sub: 'Woher kommst du?', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'Πού μένεις;', answer: 'Wo wohnst du?', options: ['Wo wohnst du?', 'Woher wohnst du?', 'Wohin wohnst du?'],
                explanation: 'Εδώ ρωτάμε για θέση κατοικίας (μόνιμη κατάσταση), οπότε "wo" — όχι "woher" (από πού) ή "wohin" (προς τα πού).' },
          ...
          { id: 'u2l3', title: 'Δουλειά & ηλικία', sub: 'Beruf & Alter', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'Είμαι φοιτητής/φοιτήτρια', answer: 'Ich bin Student', options: ['Ich bin Student', 'Ich habe Student', 'Ich mache Student'],
                explanation: 'Επαγγέλματα/ιδιότητες παίρνουν πάντα "sein" χωρίς άρθρο: "Ich bin Student" (όχι "ein Student").' },
              { prompt: 'Είμαι παντρεμένος/παντρεμένη', answer: 'Ich bin verheiratet', options: ['Ich bin verheiratet', 'Ich habe verheiratet', 'Ich bin heiraten'],
                explanation: '"Verheiratet" είναι επίθετο-μετοχή (παντρεμένος), χρησιμοποιείται πάντα με "sein" — ίδιο μοτίβο με το επάγγελμα.' },
            ] },
        ],
      },
      {
        ...
        lessons: [
          { id: 'u3l1', title: 'Αριθμοί 0-10', sub: 'Zahlen 0–10', xp: 10,
            ...
            quiz: [
              ...
              { prompt: 'είκοσι', answer: 'zwanzig', options: ['zwanzig', 'zwölf', 'zehn'],
                explanation: 'Από το 20 και πάνω οι δεκάδες παίρνουν κατάληξη "-zig" (εκτός από 30: "dreißig").' },
              { prompt: 'εκατό', answer: 'hundert', options: ['hundert', 'tausend', 'zwanzig'],
                explanation: '"(Ein)hundert" = εκατό. Στα γερμανικά συνήθως παραλείπεται το "ein" μπροστά: απλά "hundert".' },
          ...
          { id: 'u3l2', title: 'Τι ώρα είναι;', sub: 'Wie spät ist es?', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'Είναι πεντέμιση', answer: 'Es ist halb sechs', options: ['Es ist halb sechs', 'Es ist halb fünf', 'Es ist fünf halb'],
                explanation: 'Προσοχή, παγίδα! Το "halb sechs" σημαίνει "μισή ΠΡΟΣ τις έξι" δηλαδή 5:30 — αναφέρεται στην ΕΠΟΜΕΝΗ ώρα, όχι στην τρέχουσα.' },
          ...
          { id: 'u3l3', title: 'Ημέρες της εβδομάδας', sub: 'Wochentage', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'την επόμενη εβδομάδα', answer: 'nächste Woche', options: ['nächste Woche', 'letzte Woche', 'diese Woche'],
                explanation: '"Nächste" = επόμενη, "letzte" = προηγούμενη, "diese" = αυτή. Όλα συμφωνούν με το θηλυκό "die Woche".' },
              { prompt: 'Παρασκευή', answer: 'Freitag', options: ['Freitag', 'Donnerstag', 'Samstag'],
                explanation: '"Freitag" (Παρασκευή), από τη θεά Frigg της γερμανικής μυθολογίας — παρόμοιο με το αγγλικό "Friday".' },
            ] },
        ],
      },
      {
        ...
        lessons: [
          { id: 'u4l1', title: 'Αρσενικό: ο', sub: 'Der', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'το τραπέζι', answer: 'der Tisch', options: ['der Tisch', 'die Tisch', 'das Tisch'],
                explanation: 'Κανένας ιδιαίτερος κανόνας — "der Tisch" απλά απομνημονεύεται όπως και το "der Kaffee".' },
              { prompt: 'η καρέκλα', answer: 'der Stuhl', options: ['der Stuhl', 'die Stuhl', 'das Stuhl'],
                explanation: 'Παρόλο που στα ελληνικά η "καρέκλα" είναι θηλυκή, στα γερμανικά "der Stuhl" είναι αρσενικό — τα γένη δεν αντιστοιχούν μεταξύ γλωσσών!' },
            ] },
          { id: 'u4l2', title: 'Θηλυκό: η', sub: 'Die', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'η γάτα', answer: 'die Katze', options: ['die Katze', 'der Katze', 'das Katze'],
                explanation: 'Τελειώνει σε -e, ακολουθεί το μοτίβο "-e = συχνά θηλυκό" — "die Katze".' },
              { prompt: 'ο ήλιος', answer: 'die Sonne', options: ['die Sonne', 'der Sonne', 'das Sonne'],
                explanation: 'Παγίδα: αν και "ο ήλιος" είναι αρσενικός στα ελληνικά, στα γερμανικά "die Sonne" είναι θηλυκό! Αντίθετα, "der Mond" (το φεγγάρι) είναι αρσενικό — ακριβώς ανάποδα.' },
            ] },
          { id: 'u4l3', title: 'Ουδέτερο: το', sub: 'Das', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'το αυτοκίνητο', answer: 'das Auto', options: ['das Auto', 'der Auto', 'die Auto'],
                explanation: 'Λέξεις δανεικές που τελειώνουν σε -o είναι συχνά ουδέτερες: "das Auto", "das Foto", "das Radio".' },
              { prompt: 'το βιβλίο', answer: 'das Buch', options: ['das Buch', 'der Buch', 'die Buch'],
                explanation: 'Κανένας ιδιαίτερος κανόνας — "das Buch" μαθαίνεται απλά ως ουδέτερο.' },
            ] },
          { id: 'u4l4', title: 'Πληθυντικός', sub: 'Plural', xp: 20,
            ...
            quiz: [
              ...
              { prompt: 'τα σπίτια (πληθυντικός)', answer: 'die Häuser', options: ['die Häuser', 'die Hauses', 'der Häuser'],
                explanation: 'Ο ενικός "das Haus" γίνεται "die Häuser" — Umlaut (au→äu) + κατάληξη -er, ίδιο μοτίβο με "Männer".' },
              { prompt: 'οι γυναίκες (πληθυντικός)', answer: 'die Frauen', options: ['die Frauen', 'die Fraus', 'der Frauen'],
                explanation: 'Ο ενικός "die Frau" γίνεται "die Frauen" — κατάληξη -en, χωρίς Umlaut αυτή τη φορά. Δεν υπάρχει ενιαίος κανόνας, γι\' αυτό μαθαίνουμε κάθε πληθυντικό ξεχωριστά.' },
            ] },
        ],
      },
      {
        ...
        lessons: [
          { id: 'u5l1', title: 'Η οικογένειά μου', sub: 'Meine Familie', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'ο παππούς', answer: 'der Opa', options: ['der Opa', 'die Opa', 'das Opa'],
                explanation: 'Ανεπίσημη, στοργική λέξη για τον παππού — "der Opa". Επίσημα: "der Großvater".' },
              { prompt: 'η γιαγιά', answer: 'die Oma', options: ['die Oma', 'der Oma', 'das Oma'],
                explanation: 'Ανεπίσημη λέξη για τη γιαγιά — "die Oma". Επίσημα: "die Großmutter".' },
          ...
          { id: 'u5l2', title: 'Λόγια αγάπης', sub: 'Liebesworte', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'Είσαι όμορφη/όμορφος', answer: 'Du bist schön', options: ['Du bist schön', 'Du hast schön', 'Du machst schön'],
                explanation: 'Απλή δομή με "sein": "Du bist schön" (Είσαι όμορφη/ος). Το "schön" μένει αμετάβλητο, δεν παίρνει κατάληξη γένους εδώ.' },
          ...
          { id: 'u5l3', title: 'Η καθημερινότητά μας', sub: 'Unser Alltag', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'Πότε θα έρθεις σπίτι;', answer: 'Wann kommst du nach Hause?', options: ['Wann kommst du nach Hause?', 'Wo kommst du nach Hause?', 'Was kommst du nach Hause?'],
                explanation: '"Nach Hause" = προς το σπίτι (κίνηση), διαφορετικό από "zu Hause" = στο σπίτι (θέση, χωρίς κίνηση).' },
              { prompt: 'Έφαγες;', answer: 'Hast du schon gegessen?', options: ['Hast du schon gegessen?', 'Isst du schon?', 'Aßt du schon?'],
                explanation: 'Perfect tense: "haben" + μετοχή "gegessen" (από το "essen" = τρώω). Το "schon" (ήδη) ενισχύει την ερώτηση.' },
              { prompt: 'Καληνύχτα, όνειρα γλυκά', answer: 'Gute Nacht, schlaf gut', options: ['Gute Nacht, schlaf gut', 'Gute Nacht, gut schlafen', 'Schlaf gut, gute Nacht ist'],
                explanation: '"Schlaf gut" είναι προστακτική του "schlafen" (κοιμάμαι) στο ανεπίσημο β\' ενικό — κυριολεκτικά "κοιμήσου καλά".' },
            ] },
        ],
      },
      {
        ...
        lessons: [
          { id: 'u6l1', title: 'Sein & haben', sub: 'Είμαι & έχω', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'Είναι (αυτός/αυτή)', answer: 'Er/Sie ist', options: ['Er/Sie ist', 'Er/Sie hat', 'Er/Sie sind'],
                explanation: 'Γ\' ενικό πρόσωπο του "sein": "er/sie/es ist" — ξεχωριστός τύπος από το "ich bin" και το "du bist".' },
          ...
          { id: 'u6l2', title: 'Κανονικά ρήματα', sub: 'Regelmäßige Verben', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'Κάνεις (κάτι)', answer: 'Du machst', options: ['Du machst', 'Du macht', 'Du mache'],
                explanation: '"Machen" (κάνω) στο β\' ενικό: "du machst" — κανονική κατάληξη -st.' },
          ...
          { id: 'u6l3', title: 'Σειρά λέξεων', sub: 'Wortstellung', xp: 20,
            ...
            quiz: [
              ...
              { prompt: 'Τώρα πάω', answer: 'Jetzt gehe ich', options: ['Jetzt gehe ich', 'Jetzt ich gehe', 'Ich jetzt gehe'],
                explanation: 'Ίδιο μοτίβο V2: "Jetzt" (τώρα) 1η θέση, "gehe" (ρήμα) 2η, "ich" 3η.' },
          ...
          { id: 'u6l4', title: 'Ερωτηματικές λέξεις', sub: 'Fragewörter', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'Γιατί;', answer: 'Warum?', options: ['Warum?', 'Wie?', 'Was?'],
                explanation: '"Warum" ρωτά για αιτία/λόγο — απαντιέται συνήθως με "weil" (επειδή).' },
              { prompt: 'Πώς;', answer: 'Wie?', options: ['Wie?', 'Was?', 'Wer?'],
                explanation: '"Wie" ρωτά για τρόπο ή ποιότητα — ήδη το είδαμε στο "Wie geht es dir?" (Πώς είσαι;) και "Wie alt bist du?" (Πόσο χρονών είσαι;).' },
            ] },
        ],
      },
      {
        ...
        lessons: [
          { id: 'u7l1', title: 'Παραγγελία', sub: 'Bestellen', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'Μια μπίρα, παρακαλώ', answer: 'Ein Bier, bitte', options: ['Ein Bier, bitte', 'Eine Bier, bitte', 'Einen Bier, bitte'],
                explanation: '"Das Bier" είναι ουδέτερο, οπότε το αόριστο άρθρο μένει "ein" (όχι "eine" ή "einen") ακόμα και στην αιτιατική — τα ουδέτερα δεν αλλάζουν μορφή.' },
          ...
          { id: 'u7l2', title: 'Πληρωμή', sub: 'Bezahlen', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'Με κάρτα ή μετρητά;', answer: 'Mit Karte oder bar?', options: ['Mit Karte oder bar?', 'Mit Karte oder Geld?', 'Karte oder bar mit?'],
                explanation: '"Bar" εδώ σημαίνει "μετρητά" (bar bezahlen = πληρώνω μετρητά), όχι το μπαρ! Ξεχωριστή λέξη από το "die Bar".' },
          ...
          { id: 'u7l3', title: 'Προτιμήσεις φαγητού', sub: 'Essensvorlieben', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'Είμαι χορτοφάγος', answer: 'Ich bin Vegetarier', options: ['Ich bin Vegetarier', 'Ich habe Vegetarier', 'Ich esse Vegetarier'],
                explanation: 'Ιδιότητες/ταυτότητες πάντα με "sein": "Ich bin Vegetarier" — ίδιο μοτίβο με "Ich bin Student" που είδαμε στο u2.' },
              { prompt: 'Είναι πολύ νόστιμο', answer: 'Das schmeckt sehr gut', options: ['Das schmeckt sehr gut', 'Das ist sehr lecker Essen', 'Das macht sehr gut'],
                explanation: '"Schmecken" = έχω γεύση/είμαι νόστιμος — ρήμα ειδικά για γεύση φαγητού, διαφορετικό από "sein gut" (είμαι καλός).' },
            ] },
        ],
      },
      {
        ...
        lessons: [
          { id: 'u8l1', title: 'Μέσα μεταφοράς', sub: 'Verkehrsmittel', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'το λεωφορείο', answer: 'der Bus', options: ['der Bus', 'die Bus', 'das Bus'],
                explanation: '"Der Bus" — αρσενικό, ίδια λέξη σχεδόν σε πολλές γλώσσες.' },
          ...
          { id: 'u8l2', title: 'Ρωτώντας για κατεύθυνση', sub: 'Nach dem Weg fragen', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'εδώ κοντά', answer: 'in der Nähe', options: ['in der Nähe', 'in der Weite', 'im Nähe'],
                explanation: '"Die Nähe" (η εγγύτητα) είναι θηλυκό, οπότε "in der Nähe" — κυριολεκτικά "στην εγγύτητα".' },
          ...
          { id: 'u8l3', title: 'Στο σούπερ μάρκετ', sub: 'Im Supermarkt', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'το ταμείο', answer: 'die Kasse', options: ['die Kasse', 'der Kasse', 'das Kasse'],
                explanation: '"Die Kasse" (το ταμείο) — θηλυκό, τελειώνει σε -e όπως πολλά θηλυκά ουσιαστικά.' },
              { prompt: 'μια σακούλα', answer: 'eine Tüte', options: ['eine Tüte', 'ein Tüte', 'einen Tüte'],
                explanation: '"Die Tüte" θηλυκό, άρα αόριστο άρθρο "eine" στην αιτιατική (τα θηλυκά δεν αλλάζουν μορφή στην αιτιατική).' },
            ] },
        ],
      },
      {
        ...
        lessons: [
          { id: 'u9l1', title: 'Το σπίτι', sub: 'Die Wohnung', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'το μπάνιο', answer: 'das Bad', options: ['das Bad', 'der Bad', 'die Bad'],
                explanation: '"Das Bad" (μπάνιο) — ουδέτερο, σύντομος τύπος του "das Badezimmer".' },
          ...
          { id: 'u9l2', title: 'Η καθημερινή μου ρουτίνα', sub: 'Mein Tagesablauf', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'Κάνω ντους', answer: 'Ich dusche', options: ['Ich dusche', 'Ich bade', 'Ich wasche'],
                explanation: '"Duschen" (κάνω ντους), κανονικό ρήμα: "ich dusche" — μη μπερδεύεις με "baden" (κάνω μπάνιο σε μπανιέρα).' },
          ...
          { id: 'u9l3', title: 'Σχέδια για το σαββατοκύριακο', sub: 'Wochenendpläne', xp: 15,
            ...
            quiz: [
              ...
              { prompt: 'Ίσως', answer: 'Vielleicht', options: ['Vielleicht', 'Vielmal', 'Vielzeit'],
                explanation: '"Vielleicht" = ίσως — πολύ συχνή λέξη, χρήσιμη για αβέβαια σχέδια.' },
              { prompt: 'Δεν έχω σχέδια', answer: 'Ich habe keine Pläne', options: ['Ich habe keine Pläne', 'Ich habe nicht Pläne', 'Ich bin keine Pläne'],
                explanation: '"Der Plan" (πληθυντικός: die Pläne) — άρνηση ουσιαστικού με "kein/keine", ίδιο μοτίβο με "kein Fleisch" που είδαμε στο u7.' },
            ] },
        ],
      },
      {
        ...
        lessons: [
          { id: 'u10l1', title: 'Στο Bürgeramt', sub: 'Im Bürgeramt', xp: 20,
            ...
            quiz: [
              ...
              { prompt: 'η εγγραφή/δήλωση κατοικίας', answer: 'die Anmeldung', options: ['die Anmeldung', 'der Anmeldung', 'das Anmeldung'],
                explanation: '"Die Anmeldung" — η υποχρεωτική δήλωση κατοικίας στη Γερμανία, θηλυκό ουσιαστικό, τελειώνει σε -ung (πάντα θηλυκά).' },
          ...
          { id: 'u10l2', title: 'Στον γιατρό', sub: 'Beim Arzt', xp: 20,
            ...
            quiz: [
              ...
              { prompt: 'το φαρμακείο', answer: 'die Apotheke', options: ['die Apotheke', 'der Apotheke', 'das Apotheke'],
                explanation: '"Die Apotheke" — θηλυκό, τελειώνει σε -e όπως πολλά θηλυκά ουσιαστικά.' },
          ...
          { id: 'u10l3', title: 'Έκτακτη ανάγκη', sub: 'Notfall', xp: 20,
            ...
            quiz: [
              ...
              { prompt: 'φωτιά!', answer: 'Feuer!', options: ['Feuer!', 'Wasser!', 'Rauch!'],
                explanation: '"Das Feuer" = φωτιά. Ως επιφώνημα σε κίνδυνο, χρησιμοποιείται μόνο του, χωρίς άρθρο: "Feuer!".' },
              { prompt: 'η αστυνομία', answer: 'die Polizei', options: ['die Polizei', 'der Polizei', 'das Polizei'],
                explanation: '"Die Polizei" — θηλυκό, χρησιμοποιείται πάντα ενικός για το σύνολο (σαν συλλογικό ουσιαστικό), όχι στον πληθυντικό.' },
            ] },
        ],
      },
    ],
